            ...
            try {
                ...
                if (msg.mode === "ocr" && msg.imageUrl) {
                    ...
                    if (msg.mode === "spellcheck") {
                        systemPrompt += " Тщательно исправь только орфографические, грамматические и пунктуационные ошибки. Сохрани исходный стиль и формулировки там, где ошибок нет. Верни цельный исправленный текст без Markdown, звездочек и любых отметок изменений.";
