...
*   **🛡️ Управление по сайтам:** Панель автоматически доступна на веб-страницах, но LexiSync, подсказки, историю и передачу контекста можно независимо отключить для выбранного сайта через popup.
...
npm run test:unit        # быстрые модульные тесты без запуска браузера
