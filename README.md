...
- **🛡️ Доступ только к выбранным сайтам:** Постоянное разрешение выдаётся отдельно текущему домену через popup; при установке расширение не получает доступ ко всем страницам.
